...
#'
MetroPalettes <- list(
Paris = list(c("#F6BF42", "#1E57C1", "#6E6D1F", "#91C7E3", "#921F6B", "#ED652B", "#97D97F", "#EF89B3", "#97D97F", "#C787BB", "#D2D144", "#D29834", "#694A26", "#2E6745", "#97CAE4", "#5B157D" ),
             c(1, 2, 3, 33, 4, 5, 6, 7, 77, 8, 9, 10, 11, 12, 13, 14), colorblind=TRUE),
